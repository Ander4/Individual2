...
public class SetFoto1Worker extends Worker{

    public SetFoto1Worker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public ListenableWorker.Result doWork() {
        ...
        String direccion = "http://ec2-52-56-170-196.eu-west-2.compute.amazonaws.com/aeiros001/WEB/updateFoto1.php";
